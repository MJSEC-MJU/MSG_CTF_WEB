...
//   // 점수 기준 내림차순 정렬 후 상위 8팀 선택
//   const topTeams = useMemo(() => {
//     return [...data]
//       .sort((a, b) => {
//         const aMax = Math.max(...a.scores.map(s => s.value));
//         const bMax = Math.max(...b.scores.map(s => s.value));
//         return bMax - aMax;
//       })
//       .slice(0, 8);
//   }, [data]);
...
//       <TeamLabels>
//         {topTeams.map(team => (
//           <TeamLabel key={team.id} color={team.color}>
//             {team.id}
//           </TeamLabel>
//         ))}
//       </TeamLabels>

//       <ScoreTable data={topTeams} />
//     </Content>
//   );
// };
